...
public class PeriodoLetivoProfessorTesteJPA extends TestCase {
	...
	public void testAdicionar() throws Exception {
		...
		periodoLetivoProfessorTeste.setSemestre(periodoLetivoTeste);
		...
		assertEquals(periodoLetivoProfessorTeste.getSemestre(),retornoPeriodoLetivoProfessorSalvo.getSemestre());
