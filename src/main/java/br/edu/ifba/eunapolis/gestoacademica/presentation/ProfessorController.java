...
public class ProfessorController implements Serializable {
    ...
    @EJB
    private br.edu.ifba.eunapolis.gestoacademica.session.ProfessorFacade ejbFacade;
    private List<Professor> items = null;
    private Professor selected;
    ...
    public Professor prepareCreate() {
        selected = new Professor();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ProfessorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ProfessorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ProfessorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Professor> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Professor> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class ProfessorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Professor) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Professor.class.getName()});
                return null;
            }
        }
