...
import br.edu.ifba.eunapolis.gestoacademica.presentation.util.PaginationHelper;
...
public class PeriodoLetivoProfessorController implements Serializable {
    ...
    private PeriodoLetivoProfessor current;
    ...
    public PeriodoLetivoProfessor getSelected() {
        if (current == null) {
            current = new PeriodoLetivoProfessor();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (PeriodoLetivoProfessor) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PeriodoLetivoProfessorCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PeriodoLetivoProfessorUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PeriodoLetivoProfessorDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class PeriodoLetivoProfessorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PeriodoLetivoProfessor) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PeriodoLetivoProfessor.class.getName());
            }
        }
